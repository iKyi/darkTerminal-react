...
export interface InitialHackTheSystemState {
  status: IStatus;
  actor: IActorData;
  game: IPlayData;
}

const initialState: InitialHackTheSystemState = {
  actor: {
    dtac: 1000,
    sol: 10,
    tries: 1000,
...
export const selectHacking = (state: RootState) =>
  state.hackTheSystem.game.sequence;
