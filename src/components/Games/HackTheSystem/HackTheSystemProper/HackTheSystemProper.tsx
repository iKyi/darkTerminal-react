...
export type HackTheSystemProperPropsType = {
  children?: any;
};
...
const HackTheSystemProper: React.VFC<HackTheSystemProperPropsType> = ({
  children,
}) => {
  const hacking = useAppSelector((state) => state.hackTheSystem.game.hacking);
  // *************** RENDER *************** //
  return (
...
export default HackTheSystemProper;
